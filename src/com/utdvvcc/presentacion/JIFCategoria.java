...
public class JIFCategoria extends javax.swing.JInternalFrame {
    ...
    public JIFCategoria() {
        ...
        modelo.addColumn("ID");
        modelo.addColumn("Categoria Vehiculo");
        
        try {
            consultarTodos();
        } catch (SQLException ex) {
            Logger.getLogger(JIFCategoria.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        JD_Modificar.setTitle("Modificar Categoria Vehiculo");
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Categoria Vehiculo  -Tarifa Diferencial V 1.0- UTDVVCC");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Categoria Vehiculo"));
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        try {
            ...
            {
                JOptionPane.showMessageDialog(this, "El campo categoria es obligatorio");
            }
            else
            {
            ...
            cat.setCategoria(nom);
            daocat.guardar(cat);
            JOptionPane.showMessageDialog(this, "Se guardo con exito la categoria del vehiculo");
            LimpiarTabla();
            consultarTodos();
            JD_guardar.dispose();
          }
    ...
    private void btn_guardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardar1ActionPerformed
        try {
            ...
            conexion.executeUpdateQuery("UPDATE tb_categoria SET categoria='"+txt_marca1.getText().toUpperCase()+"' WHERE id_categoria="+txt_id1.getText()+"");
