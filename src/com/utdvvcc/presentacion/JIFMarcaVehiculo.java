...
import com.utdvvcc.daos.DaoMarca;
...
public class JIFMarcaVehiculo extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        JD_guardar.setTitle("Registro de Marca Vehiculo");

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Registrar Marca Vehiculo"));
        ...
        JD_Modificar.setTitle("Modificar Marca Vehiculo");

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Modificar Marca Vehiculo"));
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Marca Vehiculo  -Tarifa Diferencial V 1.0- UTDVVCC");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Marca Vehiculo"));
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(this, "Se guardo con exito la Marca del vehiculo");
            LimpiarTabla();
            consultarTodos();
            JD_guardar.dispose();
          }
    ...
    private void btn_guardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardar1ActionPerformed
        try {
            ...
            conexion.executeUpdateQuery("UPDATE tb_marca SET nombre_marca='"+txt_marca1.getText().toUpperCase()+"' WHERE id_marca="+txt_id1.getText()+"");
